...
### --- every second on R, and every minute by email should there be large price anomalies. Please refer to 
...
### --- refreshing before the 0.5 hours is up can result in your access getting banned. The tryCatch error 
### --- script however should avoid this from happening.
